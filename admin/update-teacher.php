...
<?php
             ...
             $sql = "SELECT t_id,fname,lname,email FROM teacher where t_id='$id'";
        ...
        <div class="card-body">
          <form method="post" id="teacher_login_form">
            ...
            <div class="form-group">
              ...
              <input type="text" name="fname" value="<?php echo $fname; ?>" id="teacher_password" class="form-control" />
            ...
            <div class="form-group">
              ...
              <input type="text" name="lname" value="<?php echo $lname; ?>" id="teacher_password" class="form-control" />
              <span id="error_teacher_password" class="text-danger"></span>
            </div>
            <br/>
            ...
            <div class="form-group">
              <label>EMAIL</label>
              <input type="email" name="email" value="<?php echo $email; ?>" id="teacher_password" class="form-control" />
              <span id="error_teacher_password" class="text-danger"></span>
            </div>
            <br/>
...
// @$dep=$_POST["dep"];
	...
	if($fname!='' OR $lname!='' OR $email!='')
	{
        ...
        //echo '<script>alert("Welcome to Geeks for Geeks")</script>';
          ...
          `email` = '$email' WHERE `teacher`.`t_id` = $id;";
